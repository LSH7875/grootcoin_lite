Grootcoin Core version *0.15.1* is now available from:

  <https://download.grootcoin.org/grootcoin-0.15.1/>
...
A number of changes to the way Grootcoin Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 groots per kB (0.00001 LTC). This is to prepare for dropping the minimum transaction fee to 0.1 groots per kB (0.0001 LTC) in the next release.
