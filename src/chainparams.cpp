...
{
    const char* pszTimestamp = "I'm groot";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1633255502, 177507, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x586daa24cc8179e84a784bea735333ab26be24169ea6cd3054f5cdaf53cd02fc"));
        assert(genesis.hashMerkleRoot == uint256S("0xab6a221dc0c0642f6dad1e757ad70cc7232e2f41c02fe0890c60420a6c4475f6"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        // vSeeds.emplace_back("seed-a.grootcoin.loshan.co.uk", true);
        // vSeeds.emplace_back("dnsseed.thrasher.io", true);
        // vSeeds.emplace_back("dnsseed.grootcointools.com", true);
        // vSeeds.emplace_back("dnsseed.grootcoinpool.org", true);
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1633256610, 104405, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x20c72372da392b974133043d871971fb5e0bfbfca5e244058a0184851ed68560"));
        assert(genesis.hashMerkleRoot == uint256S("0xab6a221dc0c0642f6dad1e757ad70cc7232e2f41c02fe0890c60420a6c4475f6"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("testnet-seed.grootcointools.com", true);
        vSeeds.emplace_back("seed-b.grootcoin.loshan.co.uk", true);
        ...
        checkpointData = (CCheckpointData) {
            {
                {0, uint256S("0x20c72372da392b974133043d871971fb5e0bfbfca5e244058a0184851ed68560")},
            }
        };
