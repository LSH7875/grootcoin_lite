...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s grootcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  grootcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded grootcoin transaction") + "\n" +
              "  grootcoin-tx [options] -create [commands]   " + _("Create hex-encoded grootcoin transaction") + "\n" +
              "\n";
