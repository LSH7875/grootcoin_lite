...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/grootcoin-project/grootcoin>";
    const std::string URL_WEBSITE = "<https://grootcoin.org>";
